...
@section('title')
  <title>Editar Producto y/o Servicio</title>
@endsection
...
<div class="service">
  <div class="service-first service-concept">
    <div class="service-title">
      ...
      <h2>{{ __('Editar Producto y/o Servicio') }}</h2>
    </div>
  </div>
  <form class="service-form" method="POST" action="{{ route('tenant.editServicio', $servicio) }}" enctype="multipart/form-data">
    @csrf
    @method('put')
      ...
      <div class="form-inputs">
        <div class="register-data">
          ...
          <div class="register-input">
            ...
            <input id="nombre" type="text" name="nombre" value="{{ old('nombre', $servicio->nombre) }}" autocomplete="nombre" autofocus placeholder="Página web informativa">
        ...
        <div class="register-double">
          <div class="register-data">
            ...
            <div class="register-input">
              ...
              <input id="precio" type="number" name="precio" value="{{ old('precio', $servicio->precio_bruto) }}" autocomplete="precio" autofocus min="1" placeholder="1800" step="any" onkeyup="validarPrecio(this)">
          ...
          <div class="register-data">
            ...
            <div class="register-input">
              ...
              <input id="codigo" type="text" name="codigo" value="{{ old('codigo', $servicio->codigo) }}" autocomplete="codigo" autofocus placeholder="7675645432">
        ...
        <div class="register-data">
          ...
          <div class="register-input register-file">
            ...
            <input id="imagen" type="file" name="imagen" value="{{ $servicio->imagen }}" autofocus onchange="vistaPreliminar(event)">
    ...
    <button class="form-cta cta-edit" type="submit">{{ __('Actualizar') }}</button>
  </form>
</div>
