                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('tenant.registerUser') }}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <input id="telefono" type="text" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{ old('telefono') }}" autocomplete="telefono" autofocus placeholder="xxxxxxxxxx">
