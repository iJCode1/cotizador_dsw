<div id="navv-options" class="navv-options">
  ...
  <li class="navv-element">
    <a href="{{ route('tenant.showEmpleados') }}" class="navv-ancla">
      <img src="{{ asset('images/icons/icon-empleados.svg') }}" class="navv-icon" alt="Icono de empleados" title="Empleados" width="32">
